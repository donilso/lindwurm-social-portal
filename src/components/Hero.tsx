...
const Hero = () => {
  return <div className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-lindwurm-dark via-lindwurm-dark/90 to-black z-0 bg-slate-50"></div>
      ...
      {/* Content */}
      <div className="container mx-auto px-6 relative z-10 animate-fade-in py-[50px] bg-slate-50">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight font-horizon text-[#0158ab]">LWR 
Coffee Date</h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 font-arial">
